...
#Definimos la experencia, los niveles y las listas a la cual pertenece cada jugador o enemigo


exp=0
lvl=1
#Los personajes de crecimiento rápido alcanzan el nivel 100 con 800.000 puntos de experiencia
fastGrowUp=[kobold]  #(4*(lvl)**3)/5
#Los personajes de crecimiento medio alcanzan el nivel 100 con 1.000.000 de puntos de experiencia
midGrowup=[goblin]#(lvl)**3
#Los personajes de crecimiento medio alcanzan el nivel 100 con 1.250.000 puntos de experiencia y su fórmula de crecimiento es la siguiente:
slowGrowup=[fighter,cleric,guerreroOrco] #(5*(lvl)**3)/4
#Los personajes de crecimiento ultra-lento alcanzan el nivel 100 con 1.7500.000 de puntos de experiencia
ultSlowGrowUp=[wizard]#(7*(lvl)**3)/4
